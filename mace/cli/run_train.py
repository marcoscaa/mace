...
def run(args: argparse.Namespace) -> None:
    ...
    if args.train_file.endswith(".xyz"):
        ...
        collections, atomic_energies_dict = get_dataset_from_xyz(
            ...
            atomic_dipoles_key=args.atomic_dipoles_key,
    ...
    elif args.loss == "atomic_dipoles":
        assert (
            dipole_only is True
        ), "atomic dipole loss can only be used with AtomicDipolesMACE model"
        loss_fn = modules.AtomicDipoleSingleLoss(
            dipole_weight=args.dipole_weight,
        )
    ...
    if args.model == "MACE":
        ...
        assert args.loss == "dipole" or args.loss == "atomic_dipoles", "Use dipole loss with AtomicDipolesMACE model"
        assert (
